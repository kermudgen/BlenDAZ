...
**See [docs/INDEX.md](docs/INDEX.md) for complete file reference and detailed descriptions**
...
- Active development notes → [docs/SCRATCHPAD.md](docs/SCRATCHPAD.md)
- Current tasks and roadmap → [docs/TODO.md](docs/TODO.md)
...
- **Modules**: [projects/posebridge/](projects/posebridge/) (visual posing), [projects/poseblend/](projects/poseblend/) (pose blending)
- **Docs**: All project documentation lives in [docs/](docs/) — INDEX.md, SCRATCHPAD.md, TODO.md, TECHNICAL_REFERENCE.md, templates/
...
- **PoseBridge testing**: See [projects/posebridge/TESTING_POSEBRIDGE.md](projects/posebridge/TESTING_POSEBRIDGE.md) for full checklist
...
**See [docs/INDEX.md](docs/INDEX.md) "Common Modification Points" for detailed instructions**
...
**Key technical findings** (see [docs/TECHNICAL_REFERENCE.md](docs/TECHNICAL_REFERENCE.md) for full details):
...
### ✅ arm_shrugs — FIXED (2026-02-23)
**Symptom**: Arm shrugs upward instead of reaching forward when dragging hand.
**Fix**: Analytical arm IK solver bypasses Blender's built-in IK entirely. 2-bone law of cosines with collar integration (45% damped-track with reach-distance scaling) and dynamic bend plane (Gram-Schmidt projection + dampened blending). 62/62 tests passing.
**Key files**: `daz_bone_select.py` (solver in `update_analytical_arm_drag()`), `tests/test_analytical_arm.py`

---

### ✅ knee_bends_backward — FIXED (2026-02-23)
**Symptom**: Knee bends backward, thigh twists on leg IK drag.
**Fix**: Analytical leg IK solver bypasses Blender's built-in IK entirely. 2-bone law of cosines with bone X-axis bend plane (locked, since legs have limited ROM). Works across all hip rotations including degenerate 90° cases. 57/57 tests passing.
**Key files**: `daz_bone_select.py` (solver in `update_analytical_leg_drag()`), `tests/test_analytical_leg.py`
...
- **Control point recapture**: Must run manually after moving PoseBridge outline. Run `projects/posebridge/recapture_control_points.py`.

## Documentation System

This project uses a five-file documentation system to help both humans and AI assistants work effectively. **All docs are in [docs/](docs/).**

1. **CLAUDE.md** (this file, project root) - Project context, philosophy, and development guidelines
2. **[docs/INDEX.md](docs/INDEX.md)** - Complete file reference and quick lookup for all files
3. **[docs/SCRATCHPAD.md](docs/SCRATCHPAD.md)** - Development journal for active work, experiments, and learnings
4. **[docs/TODO.md](docs/TODO.md)** - Task tracking, roadmap, and project backlog
5. **[docs/TECHNICAL_REFERENCE.md](docs/TECHNICAL_REFERENCE.md)** - Hard-won knowledge about IK, DAZ rigs, and Blender integration

### Development Patterns

**Project-specific templates** (see [docs/templates/](docs/templates/) directory):
- [Rollback plan](docs/templates/rollback-plan-template.md) - Use before risky changes (refactors, upgrades)
- [Bug status entry](docs/templates/bug-status-template.md) - Document complex bugs in STATUS section
...
**[SESSION_START.md](SESSION_START.md)** — active sub-project status, last session, what's next.
...
- IK/rig research, technical findings → [docs/TECHNICAL_REFERENCE.md](docs/TECHNICAL_REFERENCE.md)
- Decision history → [docs/SCRATCHPAD.md](docs/SCRATCHPAD.md)

**Don't front-load.** Do NOT read TECHNICAL_REFERENCE.md, SCRATCHPAD.md, or INDEX.md upfront — they are reference docs. Look things up as needed.

#### When working on this project
1. **Check the STATUS section above** — if the bug is listed, read what's already known before investigating
2. **Follow the principles** in this document (especially "Code Simplicity Principle")
3. **Update [docs/SCRATCHPAD.md](docs/SCRATCHPAD.md)** as you work — decisions, what works, bugs found
4. **Update [docs/TODO.md](docs/TODO.md)** when completing tasks or discovering new issues
5. **Update [docs/TECHNICAL_REFERENCE.md](docs/TECHNICAL_REFERENCE.md)** when finding non-obvious Blender/DAZ behaviors
6. **Update the STATUS section** when an issue is fixed, opened, or narrowed down
7. **Use development patterns** from docs/templates/ and claude-craft when situations arise
8. **Prefer simple solutions** over complex ones

#### End of session
Update [SESSION_START.md](SESSION_START.md) with current sub-project status and what's next. Takes 3-5 minutes.

### SCRATCHPAD.md Archiving

When docs/SCRATCHPAD.md reaches ~300-500 lines or ~50-75KB:
1. Create `docs/scratchpad_archive/` directory if it doesn't exist
2. Move current scratchpad to `docs/scratchpad_archive/SCRATCHPAD_YYYY-MM.md`
3. Create fresh SCRATCHPAD.md with archive reference
4. Carry forward any unfinished items

**Note**: [projects/posebridge/SCRATCHPAD.md](projects/posebridge/SCRATCHPAD.md) is currently 46KB and should be archived soon.
...
- **[docs/SCRATCHPAD.md](docs/SCRATCHPAD.md)**:
...
**Current Work**: See [docs/TODO.md](docs/TODO.md) "Current Work" section for up-to-date priorities
...
3. **Have I checked [docs/INDEX.md](docs/INDEX.md) and [docs/TODO.md](docs/TODO.md)?**
...
6. **Have I updated [docs/SCRATCHPAD.md](docs/SCRATCHPAD.md) with what I learned?**
