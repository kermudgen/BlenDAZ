...
def create_genesis8_lineart_outline(mesh_obj, outline_name="PB_Outline_LineArt"):
    ...
    # Clean up: Hide or delete mesh copy
    print("Cleaning up mesh copy...")
    mesh_copy.hide_viewport = True
    mesh_copy.hide_render = True
    print(f"  ✓ Hidden mesh copy: {mesh_copy.name}")
    ...
    print(f"  9. Cleaned up mesh copy and re-enabled original collection")
    print(f"\n✅ Critical Settings:")
