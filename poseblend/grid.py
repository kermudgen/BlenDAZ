...
def pixel_to_grid(pixel_x, pixel_y, grid_region):
    """Convert pixel coordinates to normalized grid coordinates (0-1)
    ...
    Returns:
        (x, y) normalized coordinates, or None if outside grid
    """
    # Calculate relative position within grid region
