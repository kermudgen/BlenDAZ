...
-> `projects/posebridge/core.py` -- FloatProperty slider props on PoseBridgeSettings with update callbacks
-> `projects/posebridge/panel_ui.py` -- Face Controls N-panel section
...
**Files**: `daz_shared_utils.py`, `projects/posebridge/core.py`, `projects/posebridge/panel_ui.py`
